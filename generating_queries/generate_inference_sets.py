...
print(folders)
construct_query_and_database_sets(base_path, runs_folder, folders, featurecloud_fols, "pointcloud_locations_20m_10overlap.csv", p_dict["taipo"], "hactl_{}".format(folders[0]))
